...
import { CourseService } from 'src/app/course.service';@Component({
...
export class CourseViewDetailsComponent implements OnInit {
	@Input() course: CourseModel;	constructor(private courseService: CourseService) {}	ngOnInit(): void {
		// TODO(kevinwkt): take this hardcode out.
		this.course = {
			id: 0,
			students: [],
			teacher: 'some@gmail.com',
			title: 'Subject',
			description:
